...
# This still uses the old digis, so it wont pick up the endcap 
process.load('L1Trigger.L1ExtraFromDigis.l1extraParticles_cfi')
process.l1extraParticles.isolatedEmSource    = cms.InputTag("simCaloStage2Digis")
process.l1extraParticles.nonIsolatedEmSource = cms.InputTag("simCaloStage2Digis","nonIsoEm")
process.l1extraParticles.forwardJetSource = cms.InputTag("simCaloStage2Digis","forJets")
process.l1extraParticles.centralJetSource = cms.InputTag("simCaloStage2Digis","cenJets")
process.l1extraParticles.tauJetSource     = cms.InputTag("simCaloStage2Digis","tauJets")
process.l1extraParticles.isoTauJetSource  = cms.InputTag("simCaloStage2Digis","isoTauJets")
process.l1extraParticles.etTotalSource = cms.InputTag("simCaloStage2Digis")
process.l1extraParticles.etHadSource   = cms.InputTag("simCaloStage2Digis")
process.l1extraParticles.etMissSource  = cms.InputTag("simCaloStage2Digis")
process.l1extraParticles.htMissSource  = cms.InputTag("simCaloStage2Digis")
process.l1extraParticles.hfRingEtSumsSource    = cms.InputTag("simCaloStage2Digis")
process.l1extraParticles.hfRingBitCountsSource = cms.InputTag("simCaloStage2Digis")
process.l1extraParticles.muonSource = cms.InputTag("simGtStage2Digis")

process.load("L1Trigger.L1TNtuples.l1ExtraUpgradeTreeProducer_cfi")
process.phase2_SimL1Emulator = cms.Sequence(process.SimL1EmulatorCore+process.hgcalTriggerPrimitives+process.L1TkElectrons+process.L1TkIsoElectrons+process.L1TkPhotons+process.L1TkJets+process.L1TkPrimaryVertex+process.L1TkEtMiss+process.L1TkHTMissVtx+process.L1TkMuons+process.L1TkTauFromCalo+process.l1EGammaCrystalsProducer+process.l1ParticleFlow)

process.runmenutree=cms.Path(process.phase2_SimL1Emulator*process.l1extraParticles*process.l1ExtraUpgradeTreeProducer)
...
process.schedule = cms.Schedule(process.EcalEBtp_step,process.hgcl1tpg_step,process.L1simulation_step,process.L1TrackTrigger_step,process.runmenutree,process.endjob_step,process.FEVTDEBUGHLToutput_step)
